...
%  implement the preprocessing steps for each email. We should
...
%  We should complete the code in emailFeatures.m to produce a feature
...
% different emails types). Let's try our own emails as well!
